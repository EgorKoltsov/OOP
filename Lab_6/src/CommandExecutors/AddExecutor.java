...
// A class that represents the executor of the command of addition a person to the list
public class AddExecutor implements CommandExecutor {
    ...
    // Adding human plugins to an executor
    ...
    public AddExecutor(Logger logger)
    {
        this.logger = logger;
    ...
    public void Execute(List<Human> people, String Param) {
        if (logger != null)
            logger.log("Add command executed");
